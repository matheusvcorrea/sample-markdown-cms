...
namespace DoctrineORMModule\Proxy\__CG__\Resource\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Resource extends \Resource\Entity\Resource implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', '' . "\0" . 'Resource\\Entity\\Resource' . "\0" . 'roles'];
        }
