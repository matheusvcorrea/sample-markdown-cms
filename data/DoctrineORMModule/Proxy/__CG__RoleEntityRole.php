...
namespace DoctrineORMModule\Proxy\__CG__\Role\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Role extends \Role\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', '' . "\0" . 'Role\\Entity\\Role' . "\0" . 'users', '' . "\0" . 'Role\\Entity\\Role' . "\0" . 'resources', 'privileges', '' . "\0" . 'Role\\Entity\\Role' . "\0" . 'children', '' . "\0" . 'Role\\Entity\\Role' . "\0" . 'parents'];
        }
    ...
    public function addPrivilege(\Privilege\Entity\Privilege $privilege)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPrivilege', [$privilege]);
    ...
    public function removePrivilege(\Privilege\Entity\Privilege $privilege)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removePrivilege', [$privilege]);

        return parent::removePrivilege($privilege);
    }
